...
public class CommonValidator {
    ...
    public static void checkWithdrawalTxDto(WithdrawalTxDto withdrawalTxDto) throws NulsException {
        if (withdrawalTxDto.getAssetChainId() == 0
                || withdrawalTxDto.getAssetId() == 0) {
            throw new NulsException(AccountErrorCode.PARAMETER_ERROR, "asset info error");
        }
        if (withdrawalTxDto.getHeterogeneousChainId() == 0) {
            throw new NulsException(AccountErrorCode.PARAMETER_ERROR, "heterogeneous chainId error");
        }
        ...
        if (BigIntegerUtils.isLessThan(withdrawalTxDto.getAmount(), BigInteger.ZERO)) {
            throw new NulsException(AccountErrorCode.PARAMETER_ERROR, "amount error");
        }
    }
